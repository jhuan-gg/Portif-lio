...
import FibrosLogo from '../assets/rota3.png';
  ...
  return (
    <StyledWrapper>
      <div className="card">
        ...
        <strong> Rota 3.0 </strong>
        <div className="card__body">Aplicação web em Node.js para envio e agendamento de rotas via CSV, com automação via WhatsApp.</div>
        <span><a href="https://github.com/jhuan-gg/ROTA-3.0" target='_blank'>Ver Projeto</a></span>
      </div>
    </StyledWrapper>
  );
}
